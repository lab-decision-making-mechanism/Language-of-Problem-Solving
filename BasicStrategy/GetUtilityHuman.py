...
def _readAuxiliaryData():
    ...
    '''
    # Load data
    locs_df = readLocDistance("../ConstantData/dij_distance_map_fmri.csv")
    adjacent_data = readAdjacentMap("../ConstantData/adjacent_map_fmri.csv")
    adjacent_path = readAdjacentPath("../ConstantData/dij_distance_map_fmri.csv")
...
def get_human_utility(date):
    fileFolder = "../HumanData/CorrectedTileData/" + date + "/"
    saveFolder = "../HumanData/UtilityData/" + date + "/"
