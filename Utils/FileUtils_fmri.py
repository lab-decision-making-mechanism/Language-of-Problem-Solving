...
def readAdjacentMap(filename):
    ...
    # if (31, 18) not in dict_adjacent_data:
    #     dict_adjacent_data[(31, 18)] = {}
    # dict_adjacent_data[(-1, 18)]["left"] = (31, 18)
    ...
    # dict_adjacent_data[(31, 18)]["left"] = (30, 18)
    # dict_adjacent_data[(31, 18)]["right"] = (-1, 18)
    # dict_adjacent_data[(31, 18)]["up"] = np.nan
    # dict_adjacent_data[(31, 18)]["down"] = np.nan
